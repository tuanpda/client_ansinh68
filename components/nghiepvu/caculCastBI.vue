...
export default {
  ...
  methods: {
    ...
    //   this.items[index].manguoithu = manguoithu; // lưu manguoithu ví dụ 1, 2
    //   // console.log("người thứ tại box chọn người: ", nguoithu);

    //   this.items[index].nguoithu = nguoithu; // lưu nguoithu ví dụ là Người thứ 1
